...
- Ordered brand matching for harmless case, punctuation, and apostrophe variations such as `STONE'S THROW`, `Stone's Throw`, and `STONES THROW`, without treating reordered brand words as equivalent.
