...
- Ordered brand matching for harmless case, punctuation, apostrophe, and ampersand variations such as `STONE'S THROW`, `Stone's Throw`, `STONES THROW`, and `SMITH & SONS` / `SMITH AND SONS`, without treating reordered brand words as equivalent.
