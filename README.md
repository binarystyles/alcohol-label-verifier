...
- Per-result button to download the original submitted application for human review.
...
`samples/sample_batch.zip` is generated locally and intentionally not tracked in Git because the full sample archive is larger than GitHub's file-size limits.

The generated set currently includes 198 samples covering passing applications, readable critical mismatches, missing labels, low-quality OCR review cases, Formula ID support, numeric Formula ID support, Formula `#` support-document labels, TTB ID Number formula references, pre-import approval letter references, explicit non-approved and non-current formula support statuses such as rejected or approved-superseded, exact Formula ID matching with separator variants such as `F 9200` / `F-9200`, multiple submitted formula documents where only the matching Formula ID is used, no-formula-required applications including `FORMULA NOT REQUIRED` wording, final-alcohol ranges, final-alcohol table rows with OCR-style row numbers, matched formula documents without final alcohol content, formula wording variants such as `Finished Alcohol Content`, `Finished Alcohol by Volume`, `Final Product Alcohol Content`, `Final Alcohol by Volume`, `Final ABV`, `Final Alc/Vol`, `Alcohol Content Finished Product`, `Alcohol Content of the Finished Product`, `Alcohol Content at Bottling`, `Alcohol Content as Bottled`, `Alcohol Content of the Packaged Product`, `Alcohol by Volume of Finished Product`, `Finished Product Alcohol`, `Finished Product ABV`, `Finished Product Alc/Vol`, `Finished Product Proof`, `Packaged Alcohol Content`, `Packaged Product ABV`, `Target ABV`, `Target Alc/Vol`, `Bottling Alcohol Content`, `Bottling Proof`, `Bottling ABV`, and `Bottling Alc/Vol`, proof/ABV normalization including low-proof formula support, expected proof ranges such as `80-90 Proof` and `80 Proof - 90 Proof`, adjacent dual proof/ABV label statements such as `90 Proof 45% Alc./Vol.`, `Proof 90`, `90 degrees proof`, `Alc. 45% by Vol.`, `45% Alc. by Vol.`, `45% by volume`, `Alcohol 45% by Volume`, `Alcohol: 45% by Volume`, `45% Alcohol Vol.`, `45% Alcohol/Vol.`, `13.5% vol`, decimal-comma `13,5% vol`, decimal-comma ABV ranges such as `12,5-13,5% ABV`, `Alcohol 45% by Vol.`, dotted/spaced ABV abbreviations such as `45% A.B.V.` and `A B V 50%`, and `v/v` wording, non-alcohol percentages such as `100% Agave`, non-alcohol ingredient percent-by-volume statements such as `Natural flavoring 49% by volume`, conflicting alcohol-content statements, net contents normalization including cL/centiliter labels, dotted and OCR-split metric units such as `750 M.L.` and `750 M L`, plain `12 OZ`, compact estimated quantity marks such as `e750 mL`, comma thousands such as `1,000 mL`, decimal-comma litres such as `0,75 L`, British spellings such as `750 millilitres`, fractional `1/2 Pint`, spelled-out `Seven Hundred Fifty Milliliters`, rounded dual-unit `750 mL / 25.4 FL OZ`, compound `1 Pint 0.9 FL OZ`, and multipack `4 x 50 mL`, `4-50 mL`, `4-pack of 12 fl oz`, `4/12 fl oz cans`, or word-count `six 12 fl oz cans` labels, conflicting net-contents statements, serving-size volume false-positive prevention, imported-country pass/review cases including U.S./USA, U.K./UK, Scotland/United Kingdom, Republic of Ireland/Ireland, `Scotch Whisky`, `Irish Whiskey`, `Canadian Whisky`, `Distilled in Scotland`, `Distilled and bottled in Scotland`, `Distilled, matured and bottled in Scotland`, `Blended in Scotland`, `Brewed in Belgium`, `Brewed and canned in Belgium`, `Made and bottled in Italy`, The Netherlands variants, `Produce of France`, `Wine of France`, recognized product-origin wording such as `Champagne of France`, `Sake of Japan`, `Mezcal of Mexico`, `Port of Portugal`, `Sangria of Spain`, and `Cognac of France`, `Imported by ... from France` and `Imported into ... from France` wording, conflicting origin statements, bottling-location-only origin review, and domestic/no-imported-origin applications whose labels contain foreign origin wording, missing required application values, ambiguous multiple Item 5 product-type checkboxes, ambiguous multiple Item 3 Domestic/Imported checkboxes, supplied fanciful-name review, supplemental label pages after attached instruction pages, supplemental labels after long attachment sections, split front/back panel labels whose required elements are spread across panels, front/back panel conflicts such as competing ABV statements, assignment-style brand capitalization tolerance such as application `Stone's Throw` matching label `STONE'S THROW`, brand ampersand/`AND`, `No.`/`#` number marker variations, legal suffix variants such as `Co.`/`Company`, `Inc.`/`Incorporated`, `Corp.`/`Corporation`, `Ltd.`/`Limited`, and `L.L.C.`/`LLC`, `St.`/`Saint`, curly apostrophe, diacritic variations, and OCR-like character-substitution review for required brand text, brand text appearing only in bottler/importer context, reordered brand words, distinct legal suffixes that should not be treated as equivalent, incidental product-type words inside brand names, product-type words appearing only in primary brand text, explicit product-type text before brand text including `BEER`, `LAGER BEER`, `MALT LIQUOR`, `FLAVORED MALT BEVERAGE`, `IPA`, `Pilsner`, first-line `HARD SELTZER`, modified first-line class/style statements such as `SPARKLING HARD SELTZER`, `IMPERIAL STOUT`, `STRAIGHT RYE WHISKEY`, `BARLEYWINE ALE`, `TEQUILA BARREL AGED BEER`, and `HARD CIDER`, modified hard-cider statements such as `APPLE HARD CIDER`, conflicting explicit product-type statements, distilled-spirits product-type support from clear class/type statements such as `Gin`, `Liqueur`, `Vodka Cocktail`, and distilled-spirits specialty/cocktail labels without a separate product-type line, first-line class/type product-type evidence, wine product-type support from hard-cider/perry terms, 27 CFR wine class/type terms such as `Sake`, `Vermouth`, `Sherry`, `Port`, `Champagne`, `Mead`, and `Sangria`, and common grape-varietal type designations such as `Chardonnay`, class/type word-fragment false-positive prevention, explicit class/type values that include product-type words such as `Distilled Spirits Specialty`, conflicting class/type statements, class/type text appearing only inside the brand line, bottler/producer text appearing only outside responsible-party context, responsible-party wording such as `Distilled by`, `Blended by`, `Bottled by:`, `Bottled for`, `Bottled exclusively for`, `Filled by`, `Made by`, `Prepared by`, `Manufactured by`, `Mfg. by`, `Mfr. by`, `Canned by`, `Packed by`, `Produced and bottled by`, and comma/slash-separated action lists such as `Distilled, bottled and packaged by`, `Produced/Bottled by`, or `Imported, bottled and distributed by`, distribution-only and bottled-under-authority responsible-party review, role-aware separate-line and one-line `Bottled for` plus `Bottled by` responsible-party handling, conflicting same-role responsible-party statements, mixed/lowercase and hyphenated/colon-punctuated government warning headings, OCR-damaged government warning headings, product-type mismatch failures, product-type descriptors such as wine-cask-finished spirits, descriptor-only wine wording such as `Wine Barrel Finished` on distilled spirits, Item 15 review, and color-artwork labels including crest-style artwork, textured artwork, ornate overprint-style artwork, busy artwork, dark/reversed text, colored warning panels, noisy low-contrast artwork, tiny low-quality warning text, photo-like scenic artwork with readable and low-contrast OCR-quality outcomes, metallic-foil effects, dense illustrations behind required text, stylized fonts, curved/distorted text, low-contrast embossed text, and partial glare/scanning artifacts. See `samples/expected_outcomes.md` for the full sample list and expected Pass / Needs Review / Fail outcomes.

Supplied wine-only Item 10 grape varietals and Item 11 wine appellation values are now field-level label checks; missing or partially missing label evidence routes the application to Needs Review.
