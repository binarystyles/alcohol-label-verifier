...
- Imported country of origin is missing or the country name appears only in unrelated text, such as an importer company name, rather than in origin wording like `Product of`. United States origin can match common label abbreviations such as `USA`, `U.S.A.`, and `U.S.`.
