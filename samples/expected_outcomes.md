...
| --- | --- | --- |
| `APP-001_old_tom_pass.pdf` | Pass | Fully passing label with matching approved formula alcohol content, application summary, and affixed label text. |
| `APP-002_stones_throw_variation.pdf` | Pass | Brand punctuation/case variation should not fail. |
| `APP-003_wrong_abv.pdf` | Fail | Approved formula expects 45% ABV but label shows 40% ABV. |
