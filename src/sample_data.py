...
def sample_specs() -> list[SampleSpec]:
    ...
    return [
        ...
        SampleSpec(
            filename="APP-164_hyphen_pack_net_contents_pass.pdf",
            fields={
                **malt_fields,
                "serial_number": "APP-164",
                "formula": "MB-16400",
            ...
            label_lines=[
                ...
                "Class/Type: Flavored Malt Beverage",
                "5.5% Alc./Vol.",
                "Net Contents 4-pack of 12 fl oz cans",
                "Brewed by Harbor Light Brewing Co.",
                GOVERNMENT_WARNING,
            ],
            expected_status="Pass",
        ...
        SampleSpec(
            filename="APP-172_wine_varietal_appellation_missing_review.pdf",
            fields={
                **wine_fields,
                "serial_number": "APP-172",
                ...
                "class_type": "Red Wine",
                "alcohol_content": "13.5% ABV",
                "bottler_producer": "Valley Ridge Winery",
            },
            label_lines=[
                "VALLEY RIDGE",
                "Reserve Red",
                ...
                "13.5% Alc./Vol.",
                "750 mL",
                "Bottled by Valley Ridge Winery",
                GOVERNMENT_WARNING,
            ],
            expected_status="Needs Review",
        ...
        SampleSpec(
            filename="APP-174_first_line_sparkling_hard_seltzer_pass.pdf",
            fields={
                **malt_fields,
                "serial_number": "APP-174",
                "brand_name": "HARBOR LIGHT SELTZER",
                "formula": "MB-17400",
                "class_type": "Hard Seltzer",
            },
            label_lines=[
                "SPARKLING HARD SELTZER",
                "HARBOR LIGHT SELTZER",
                "5.5% Alc./Vol.",
                "12 fl oz",
                "Brewed by Harbor Light Brewing Co.",
            ...
            expected_status="Pass",
            note="A first-line modified hard-seltzer class phrase should satisfy malt-beverage product type and class/type checks.",
        ),
        SampleSpec(
            filename="APP-175_first_line_imperial_stout_pass.pdf",
            fields={
                **malt_fields,
                "serial_number": "APP-175",
                "brand_name": "BLACK PIER STOUT",
                "formula": "MB-17500",
                "class_type": "Stout",
            ...
            expected_status="Pass",
            note="A first-line modified beer style should satisfy malt-beverage product type and class/type checks.",
        ),
        SampleSpec(
            filename="APP-176_first_line_straight_rye_whiskey_pass.pdf",
            fields={
                **BASE_FIELDS,
                "serial_number": "APP-176",
        ...
        SampleSpec(
            filename="APP-189_barleywine_ale_malt_pass.pdf",
            fields={
                **malt_fields,
                "serial_number": "APP-189",
                "brand_name": "HARBOR LIGHT BARLEYWINE",
                "fanciful_name": "Winter Reserve",
                "formula": "MB-18900",
                "class_type": "Barleywine Ale",
                "alcohol_content": "9.5% ABV",
                "net_contents": "12 fl oz",
                "bottler_producer": "Harbor Light Brewing Co.",
            },
            label_lines=[
                "BARLEYWINE ALE",
                "HARBOR LIGHT BARLEYWINE",
                "Winter Reserve",
                "9.5% Alc./Vol.",
                "12 fl oz",
                "Brewed and canned by Harbor Light Brewing Co.",
            ...
            expected_status="Pass",
            note="Barleywine/Barley Wine is a malt-beverage beer style and should not be treated as wine or an ambiguous product type.",
        ),
        SampleSpec(
            filename="APP-190_tequila_barrel_aged_beer_pass.pdf",
            fields={
                **malt_fields,
                "serial_number": "APP-190",
                "brand_name": "DESERT CASK",
                "fanciful_name": "",
                "formula": "MB-19000",
                "class_type": "Barrel Aged Beer",
                "alcohol_content": "7% ABV",
                "net_contents": "12 fl oz",
                "bottler_producer": "Harbor Light Brewing Co.",
            },
