...
def _split_flat_label_line(line: str) -> list[str]:
    split_markers = (
        ...
        r"\b(?:BOTTLED|PRODUCED|DISTILLED|IMPORTED|BREWED|VINTED|CELLARED|PACKAGED|MANUFACTURED|DISTRIBUTED)(?:\s+AND\s+(?:BOTTLED|PRODUCED|DISTILLED|IMPORTED|BREWED|VINTED|CELLARED|PACKAGED|MANUFACTURED|DISTRIBUTED))*\s+BY\b",
