...
def _split_flat_label_line(line: str) -> list[str]:
    split_markers = (
        ...
        r"\b(?:BOTTLED|PRODUCED|DISTILLED|BLENDED|IMPORTED|BREWED|VINTED|CELLARED|PACKED|PACKAGED|MANUFACTURED|DISTRIBUTED)(?:\s+AND\s+(?:BOTTLED|PRODUCED|DISTILLED|BLENDED|IMPORTED|BREWED|VINTED|CELLARED|PACKED|PACKAGED|MANUFACTURED|DISTRIBUTED))*\s+(?:BY|FOR)\b",
