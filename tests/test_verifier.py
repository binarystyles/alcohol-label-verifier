...
def test_net_contents_match_passes_with_multipack_statement() -> None:
    ...
    assert verify_net_contents("200 mL", "Net Contents 4 - 50 mL").status == STATUS_PASS
    assert verify_net_contents("200 mL", "Net Contents four x 50 mL").status == STATUS_PASS
    ...
    assert verify_net_contents("72 fl oz", "Net Contents six 12 fl oz cans").status == STATUS_PASS
    assert verify_net_contents("72 fl oz", "Net Contents six-pack of 12 fl oz cans").status == STATUS_PASS
    assert verify_net_contents("2130 mL", "Net Contents six 355 mL bottles").status == STATUS_PASS
